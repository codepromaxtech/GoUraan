...
let SabreService = SabreService_1 = class SabreService {
    constructor(configService) {
        this.configService = configService;
        this.logger = new common_1.Logger(SabreService_1.name);
    ...
    async getAccessToken() {
        ...
        try {
            ...
            const response = await axios_1.default.post(`${this.baseUrl}/v2/auth/token`, 'grant_type=client_credentials', {
                headers: {
    ...
    async searchFlights(searchParams) {
        try {
            ...
            const response = await axios_1.default.post(`${this.baseUrl}/v1/shop/flights`, payload, {
                headers: {
    ...
    async getFlightDetails(flightId) {
        try {
            const token = await this.getAccessToken();
            const response = await axios_1.default.get(`${this.baseUrl}/v1/shop/flights/${flightId}`, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
            });
    ...
    async reserveFlight(reservationData) {
        try {
            ...
            const response = await axios_1.default.post(`${this.baseUrl}/v2.3.0/passenger/records`, payload, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
                },
    ...
    async confirmBooking(pnr) {
        try {
            ...
            const response = await axios_1.default.post(`${this.baseUrl}/v2.0.9/passenger/records/${pnr}`, payload, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
                },
    ...
    async cancelBooking(pnr, reason) {
        try {
            ...
            const response = await axios_1.default.post(`${this.baseUrl}/v1.0.0/passenger/records/${pnr}/cancel`, payload, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
                },
    ...
    async getFlightStatus(pnr) {
        try {
            const token = await this.getAccessToken();
            const response = await axios_1.default.get(`${this.baseUrl}/v1/lists/supported/shop/flights/status`, {
                headers: {
                    'Authorization': `Bearer ${token}`,
                },
                params: {
    ...
    transformFlightResults(itineraryGroups) {
        const flights = [];
...
exports.SabreService = SabreService = SabreService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [config_1.ConfigService])
], SabreService);
//# sourceMappingURL=sabre.service.js.map