        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {packages.length === 0 ? (
            <div className="col-span-3 bg-white rounded-lg shadow p-12 text-center">
              ...
              <p className="text-gray-500 text-lg font-medium mb-2">No packages found</p>
              <p className="text-gray-400 text-sm mb-4">Create your first travel package to get started</p>
              <button
                onClick={() => setShowCreateModal(true)}
            ...
            packages.map((pkg) => (
              <div key={pkg.id} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-gray-500 mb-4">{pkg.type} • {pkg.duration}</p>
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-2xl font-bold text-blue-600">{pkg.currency} {pkg.price}</p>
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    placeholder="Describe the package details, inclusions, and highlights..."
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
                ...
                <div className="flex gap-3 mt-6">
                  <button
                    type="button"
                    onClick={() => {
                      alert('Package creation will be connected to backend API');
